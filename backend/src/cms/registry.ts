...
export const CONTENT_REGISTRY = {
  ...
  'videos.cta.primary': {
    ...
    section: 'videos',
    hint: 'JSON: { "label", "href" }',
    defaultBody: JSON.stringify({ label: 'View Events', href: '/events' }, null, 2),
  },
  ...
  'events.cta.primary': {
    ...
    section: 'events',
    hint: 'JSON: { "label", "href" }',
    defaultBody: JSON.stringify({ label: 'Browse Programs', href: '/programs' }, null, 2),
  },
  ...
  'programs.sections.visible': {
    ...
    hint: 'JSON object of section-key → true/false. Missing keys default to visible.',
    defaultBody: JSON.stringify(
      { benefits: true, catalog: true, testimonials: true, cta: true },
      null,
      2,
    ),
  },
  'events.sections.visible': {
    ...
    hint: 'JSON object of section-key → true/false. Missing keys default to visible.',
    defaultBody: JSON.stringify(
      { featured: true, calendar: true, highlights: true, newsletter: true, cta: true },
      null,
      2,
    ),
  },
  'support.sections.visible': {
    ...
    hint: 'JSON object of section-key → true/false. Missing keys default to visible.',
    defaultBody: JSON.stringify(
      { donation: true, otherWays: true, transparency: true, standards: true, donate: true, cta: true },
      null,
      2,
    ),
  },
